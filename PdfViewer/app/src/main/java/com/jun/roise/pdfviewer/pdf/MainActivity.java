...
import com.jun.roise.pdfviewer.pdf.util.WarpUtil;
...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_pdf) {
            WarpUtil.warpPdfView(this);
        } else if (id == R.id.nav_file_search) {
            WarpUtil.warpFileFolderView(this);
        }
